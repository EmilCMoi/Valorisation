...
def create_structure(r):
    ...
    positions[1] = np.array([0, 0, 0]) + v1 / 3 - v2 / 3+r
...
#results=minimize(to_min,x0=[1.1696333, 0.47022198, 0.89701883, 0.91710029, 0.23833778],method='BFGS')

print(results)
xx=results[0]
#xx=results.x
#xx=[1.19056847, 0.49963957, 0.93902877, 0.75712184, 0.2852746]
